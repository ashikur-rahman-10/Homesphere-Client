...
const Footer = () => {
  return (
    <div className="bg-gradient-to-tl from-[#aef7fa] via-white to-white relative border text-[#626687]">
        ...
        <div className="space-y-3">
          ...
          <div className="text-[#626687]">
            <div className="grid grid-flow-col gap-4 ">
              <Link to={"https://x.com/nrelltd"} target="blank">
                <svg
              ...
              <a
                href="https://www.youtube.com/@nrelltd"
              ...
              <a
                href="https://www.facebook.com/nreltd"
                className="cursor-pointer"
                target="blank"
              >
                <svg
